...
# System log table cross-database problem

> If the microservice module is configured with an independent data source, the database corresponding to each service must also have `sys_log`this table.
