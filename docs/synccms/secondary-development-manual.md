...
1. # <a name="_toc122375211"></a>**Introduction to PublicCMS**
...
1. ## <a name="_toc483039313"></a><a name="_toc22743464"></a><a name="_toc118193148"></a><a name="_toc122375214"></a>**Get PublicCMS**
...
- publiccms-parent is the source code of PublicCMS
- data/publiccms is the data directory of PublicCMS
...
| <p>cd publiccms-parent</p><p>mvnw clean package</p><p>cd publiccms/target</p><p>java -jar publiccms.war</p> |
| ----------------------------------------------------------------------------------------------------------- |
...
![](/cms/secondary-development/013.png)
...
![](/cms/secondary-development/026.png)
...
1. ### **Start the Process**
   After starting the container, the container will load the application’s web.xml, scan The implementation class of ServletContainerInitializer, began to initialize the spring and the spring s initialize multiple initializers of PublicCMS separately and register the configuration class .

![](/cms/secondary-development/031.jpeg "23-09-540845-2088983653")
...
![](/cms/secondary-development/032.jpeg "10-12-120047604149849")

1. ### **Processing Template Paths**
   ![](/cms/secondary-development/033.jpeg "17-44-130387-1456924387")
...
1. Configurate Database information
   ...
   Modify the total database information of configuration file: publiccms\src\test\resources\hibernate\hibernate.properties.

1. com.publiccms.common.generator. EntitysGenerator generate entity file;
...
1 For entity property, use com.publiccms.common.generator.annotation.GeneratorColumn to mark class tag.
...
PublicCMS automatically completes the registration of directives during startup. The directive name is the class name removed of Cms, Directive character and the prefix of the last package name ; first letter in lower case; the namespace is the last package name.
...
An instruction needs to inherit [com.publiccms.common.base.BaseMethod](t) class and implements public Object exec(@SuppressWarnings("rawtypes") List arguments) throws TemplateModelException method; Add @Component annotation and put in an “com. Publiccms “ package.
