import{_ as t,c as n,a as d,o as s}from"./app-DeddRHAy.js";const a={};function i(l,e){return s(),n("div",null,e[0]||(e[0]=[d(`<h1 id="tree" tabindex="-1"><a class="header-anchor" href="#tree"><span>Tree</span></a></h1><p>Encapsulate <code>antv</code>the tree component</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;template&gt;</span>
