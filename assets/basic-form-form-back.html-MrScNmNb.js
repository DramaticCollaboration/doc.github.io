import{_ as n,c as s,a,o as i}from"./app-CU20V-HQ.js";const t={};function l(d,e){return i(),s("div",null,e[0]||(e[0]=[a(`<h1 id="basicform-form-back" tabindex="-1"><a class="header-anchor" href="#basicform-form-back"><span>BasicForm form back</span></a></h1><p>Encapsulate <code>antv</code>the form component and expand some common functions</p><blockquote><p>If it is not in the documentation, try looking for it in the online examples.</p></blockquote><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><h3 id="the-useform-method" tabindex="-1"><a class="header-anchor" href="#the-useform-method"><span>The useForm method</span></a></h3><p>Here is an example using a simple form with only one input box</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;template&gt;</span>
...
<span class="line">},</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>copy</p>`,160)]))}const c=n(t,[["render",l]]),o=JSON.parse('{"path":"/syncadmin/ui-component-library/more-basic-components/basic-form-form-back.html","title":"BasicForm form back","lang":"ko-KR","frontmatter":{"order":32},"git":{"updatedTime":1749507909000,"contributors":[{"name":"poh","username":"poh","email":"poh@empasy.com","commits":1,"url":"https://github.com/poh"}],"changelog":[{"hash":"b750c3240053572cbcbb08ac1e9cd0bd9974af53","time":1749507909000,"email":"poh@empasy.com","author":"poh","message":"build to docs:build"}]},"filePathRelative":"syncadmin/ui-component-library/more-basic-components/basic-form-form-back.md"}');export{c as comp,o as data};
