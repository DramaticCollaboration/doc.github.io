import{_ as n,c as s,a,o as i}from"./app-DGEuurYf.js";const t={};function l(d,e){return i(),s("div",null,e[0]||(e[0]=[a(`<h1 id="basicform-form-back" tabindex="-1"><a class="header-anchor" href="#basicform-form-back"><span>BasicForm form back</span></a></h1><p>Encapsulate <code>antv</code>the form component and expand some common functions</p><blockquote><p>If it is not in the documentation, try looking for it in the online examples.</p></blockquote><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><h3 id="the-useform-method" tabindex="-1"><a class="header-anchor" href="#the-useform-method"><span>The useForm method</span></a></h3><p>Here is an example using a simple form with only one input box</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;template&gt;</span>
