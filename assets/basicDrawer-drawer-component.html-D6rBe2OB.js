import{_ as n,c as s,a,o as t}from"./app-DGEuurYf.js";const i={};function r(l,e){return t(),s("div",null,e[0]||(e[0]=[a(`<h1 id="basicdrawer-drawer-component" tabindex="-1"><a class="header-anchor" href="#basicdrawer-drawer-component"><span>BasicDrawer drawer component</span></a></h1><p>Encapsulate <code>antv</code>the drawer component and expand functions such as drag, full screen, and adaptive height.</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><p><strong>Since the internal code of the drawer is usually separated into separate files, it is recommended to develop it as a separate component, so the examples are explained in separate files.</strong></p><p><strong>Independent component code, used to write the content inside the component</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;template&gt;</span>
