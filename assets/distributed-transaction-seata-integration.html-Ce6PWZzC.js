import{_ as s,c as a,a as n,o as t}from"./app-QFoJTndn.js";const i={};function l(r,e){return t(),a("div",null,e[0]||(e[0]=[n(`<h1 id="distributed-transaction-seata-integration" tabindex="-1"><a class="header-anchor" href="#distributed-transaction-seata-integration"><span>Distributed transaction Seata integration</span></a></h1><h2 id="prepare-the-environment" tabindex="-1"><a class="header-anchor" href="#prepare-the-environment"><span><strong>Prepare the environment</strong></span></a></h2><ol><li>Create four databases as follows</li></ol><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">jeecg_order（订单数据库）</span>
