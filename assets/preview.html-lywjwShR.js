import{_ as n,c as s,a,o as t}from"./app-QFoJTndn.js";const i={};function l(d,e){return t(),s("div",null,e[0]||(e[0]=[a(`<h1 id="preview" tabindex="-1"><a class="header-anchor" href="#preview"><span>Preview</span></a></h1><p>Make the image preview component functional. It is convenient to create components through functions.</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;template&gt;</span>
