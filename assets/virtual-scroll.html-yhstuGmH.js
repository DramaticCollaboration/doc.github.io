import{_ as n,c as t,a,o as l}from"./app-CGhJnnYK.js";const i={};function e(d,s){return l(),t("div",null,s[0]||(s[0]=[a(`<h1 id="virtualscroll" tabindex="-1"><a class="header-anchor" href="#virtualscroll"><span>VirtualScroll</span></a></h1><p>Virtual scrolling component (used for pure display of large amounts of data)</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;template&gt;</span>
