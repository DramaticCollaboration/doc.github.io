import{_ as t,c as s,a as n,o as a}from"./app-CU20V-HQ.js";const l={};function i(d,e){return a(),s("div",null,e[0]||(e[0]=[n(`<h1 id="strengthmeter" tabindex="-1"><a class="header-anchor" href="#strengthmeter"><span>StrengthMeter</span></a></h1><p>Used to check password strength</p><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;template&gt;</span>
