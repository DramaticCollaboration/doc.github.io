import{_ as e,c as s,a as n,o as i}from"./app-DeddRHAy.js";const t={};function l(c,a){return i(),s("div",null,a[0]||(a[0]=[n(`<h1 id="dynamic-data-source-usage" tabindex="-1"><a class="header-anchor" href="#dynamic-data-source-usage"><span>Dynamic data source usage</span></a></h1><p>Druid dynamic data source</p><h3 id="_1-dynamic-data-source-configuration" tabindex="-1"><a class="header-anchor" href="#_1-dynamic-data-source-configuration"><span>1. Dynamic data source configuration</span></a></h3><p>/src/main/resources/application.yml</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">datasource:</span>
