...
<span class="line">  });</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>copy</p><div class="hint-container tip"><p class="hint-container-title">Why inject code through plugins instead of directly inserting it in main.ts</p><p>By inserting code in the plugin <code>injectCode</code>, it is convenient to control whether mockjs is packaged into the final code. If you judge in main.ts, if the mock function is turned off, mockjs will also be packaged into the build file, which will increase the package size.</p></div><p>At this point, the online mock configuration is complete. There is little difference between online and local. The biggest difference is that you cannot see the interface request log in the online console.</p>`,114)]))}const d=s(l,[["render",r]]),p=JSON.parse('{"path":"/syncadmin/front-end-configuration/in-depth/data-mock-joint-debugging.html","title":"Data mock & joint debugging","lang":"ko-KR","frontmatter":{"order":7},"git":{"updatedTime":1749510018000,"contributors":[{"name":"poh","username":"poh","email":"poh@empasy.com","commits":1,"url":"https://github.com/poh"}],"changelog":[{"hash":"b5c965c32dfeaa81de62133194782387bf36abfc","time":1749510018000,"email":"poh@empasy.com","author":"poh","message":"로고 표시 오류 수정"}]},"filePathRelative":"syncadmin/front-end-configuration/in-depth/data-mock-joint-debugging.md"}');export{d as comp,p as data};
