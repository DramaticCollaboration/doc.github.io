import{_ as n,c as e,a,o as l}from"./app-QFoJTndn.js";const i={};function c(p,s){return l(),e("div",null,s[0]||(s[0]=[a(`<h1 id="usage-examples" tabindex="-1"><a class="header-anchor" href="#usage-examples"><span>Usage Examples</span></a></h1><h2 id="example-1" tabindex="-1"><a class="header-anchor" href="#example-1"><span>Example 1</span></a></h2><blockquote><p>This example demonstrates <code>JVxeTable</code>the basic usage of</p></blockquote><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;JVxeTable</span>
