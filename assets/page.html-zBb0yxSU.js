import{_ as t,c as a,a as n,o as s}from"./app-QFoJTndn.js";const l={};function d(i,e){return s(),a("div",null,e[0]||(e[0]=[n(`<h1 id="page" tabindex="-1"><a class="header-anchor" href="#page"><span>Page</span></a></h1><p>Page related components</p><h2 id="pagewrapper" tabindex="-1"><a class="header-anchor" href="#pagewrapper"><span>PageWrapper</span></a></h2><p>Used to wrap page components</p><h3 id="usage" tabindex="-1"><a class="header-anchor" href="#usage"><span>Usage</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;template&gt;</span>
