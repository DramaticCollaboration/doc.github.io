import{_ as s,c as a,a as n,o as i}from"./app-QFoJTndn.js";const l={};function c(t,e){return i(),a("div",null,e[0]||(e[0]=[n(`<h1 id="configuration-files" tabindex="-1"><a class="header-anchor" href="#configuration-files"><span>Configuration Files</span></a></h1><h2 id="configuration-files-1" tabindex="-1"><a class="header-anchor" href="#configuration-files-1"><span>Configuration Files</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">jeecg-module-system\\jeecg-system-start\\</span>
